class GRAY_AdjustDoorAction : SCR_AdjustSignalAction
{
	protected static const float STEP = 0.05;
...
class GRAY_OpenDoorAIAction : ScriptedUserAction
{
	protected DoorComponent m_doorComponent;
	...
	{
		if (!EntityUtils.IsPlayer(user))
			m_doorComponent.SetControlValue(1);
